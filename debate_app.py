...
def render_left_panel():
    ...
    with st.sidebar:
        ...
        use_openai = st.checkbox(f"{ui_texts.LLM_OPENAI} {'✅' if openai_key else '❌'}", value=bool(openai_key))
        ...
        use_gemini = st.checkbox(f"{ui_texts.LLM_GEMINI} {'✅' if gemini_key else '❌'}", value=bool(gemini_key))
        ...
        use_deepseek = st.checkbox(f"{ui_texts.LLM_DEEPSEEK} {'✅' if deepseek_key else '❌'}", value=bool(deepseek_key))
